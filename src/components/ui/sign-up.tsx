...
export const SignUpPage: React.FC<SignUpPageProps> = ({
  title = <span className="font-light text-foreground tracking-tighter">Join Skillery</span>,
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignUp}>
              ...
              <div className="animate-element animate-delay-700 flex items-start gap-3 text-sm">
                <input type="checkbox" name="agreeToTerms" className="custom-checkbox mt-0.5" required />
